...
//     TORCH_CHECK(value.scalar_type().is_cuda(), "value must be a CUDA tensor");
//     TORCH_CHECK(spatial_shapes.scalar_type().is_cuda(), "spatial_shapes must be a CUDA tensor");
//     TORCH_CHECK(level_start_index.scalar_type().is_cuda(), "level_start_index must be a CUDA tensor");
//     TORCH_CHECK(sampling_loc.scalar_type().is_cuda(), "sampling_loc must be a CUDA tensor");
//     TORCH_CHECK(attn_weight.scalar_type().is_cuda(), "attn_weight must be a CUDA tensor");
...
//     TORCH_CHECK(sampling_loc.scalar_type().is_cuda(), "sampling_loc must be a CUDA tensor");
//     TORCH_CHECK(attn_weight.scalar_type().is_cuda(), "attn_weight must be a CUDA tensor");
//     TORCH_CHECK(grad_output.scalar_type().is_cuda(), "grad_output must be a CUDA tensor");
